...
public class TelaCliente extends javax.swing.JInternalFrame {
    ...
    // Criando função para adicionar clientes
    private void adicionar() {
        ...
        try {
            ...
            if ((txtCliNome.getText().isEmpty() || txtCliFone.getText().isEmpty())) {
                ...
                // Realizando o Update na Tabela Clientes com os dados do form
                ...
                if (adicionado > 0) {
                    ...
                    JOptionPane.showMessageDialog(null, "Ocorreu um erro ao adicionar o Cliente!");
                }
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (((txtCliNome.getText().isEmpty() || txtCliFone.getText().isEmpty() ))) {
                ...
                if (adicionado > 0) {
                    ...
                    JOptionPane.showMessageDialog(null, "Ocorreu um erro ao alterar os dados do Cliente!");
                }
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
    ...
    private void remover() {
        // a estrutura abaxio confirma a remoção do cliente
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtCliFone, javax.swing.GroupLayout.DEFAULT_SIZE, 450, Short.MAX_VALUE)
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        // Chamando a função de adicionar cliente
        adicionar();
    }//GEN-LAST:event_btnAdicionarActionPerformed

    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        // Chama a função de Consultar Cliente
        consultar();
    }//GEN-LAST:event_btnConsultarActionPerformed

    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        // Chama a função de Alterar dados do Cliente
        alterar();
    }//GEN-LAST:event_btnAlterarActionPerformed

    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        // Chama a função de Remover Clientes
        remover();
